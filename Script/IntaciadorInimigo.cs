...
public class IntaciadorInimigo : MonoBehaviour
{
  ...
  //  public GameObject player;
    ...
    public GameObject poartcamera,seta;
    ...
    void Update()
    {
        ...
        if (intanciar == true )
        {
            ...
            if (espera<=0)
            {
                ...
                int ranini = Random.Range(0, 3);
                if (rannum==0)
                {
                    espera = 2;
                    numinimigos--;
                    Instantiate(inimigo[ranini], intanciar1.position, Quaternion.identity);
                }
                else
                {
                    numinimigos--;
                    espera = 2;
                    Instantiate(inimigo[ranini], intanciar2.position, Quaternion.identity);
                }
                if (numinimigos==0)
                {
                    intanciar = false;
